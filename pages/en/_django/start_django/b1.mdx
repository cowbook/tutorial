...
*Django* is an integrated framework for web development using `Python`, offering convenience in creating and developing integrated web services. It inherently provides a web server (including Http, Https, WebSocket), static files, front-end HTML templates, database object models, data querying (`QuerySet`), and more. It allows database use without learning SQL.It can automaticlly generate a backend admin site based on your models.

Considering it's a development environment, A IDE which is free, beginner-friendly, and efficient is truly what we indeed need. We use Visual Studio Code (VsCode), which also provides excellent support for front-end technologies like React, Vue, TS, and JS.

Setting up the **Django** development environment mainly involves 4 steps: 
...
![1704157608176](../../../_django/start_django/image/1.startup/1704157608176.png)
...
![1704159355737](../../../_django/start_django/image/1.startup/1704159355737.png)

VsCode will open Microsoft Store to let you install python

![1704159613630](../../../_django/start_django/image/1.startup/1704159613630.png)
...
![1704163830216](../../../_django/start_django/image/1.startup/1704163830216.png)
...
![1704164146503](../../../_django/start_django/image/1.startup/1704164146503.png)

### 2)Using the virtual environment

As following, we click the right bottom area to select the ENV environment.

![1704168889412](../../../_django/start_django/image/1.startup/1704168889412.png)


We run the test.py file and find out the runtime path has changed to ./env folder

![1704186920246](../../../_django/start_django/image/1.startup/1704186920246.png)

VS Terminal need be reloaded, if a warning shows like following

![1704187964838](../../../_django/start_django/image/1.startup/1704187964838.png)
...
![1704187398914](../../../_django/start_django/image/1.startup/1704187398914.png)
...
![1704197648960](../../../_django/start_django/image/1.startup/1704197648960.png)
...
![1704197812260](../../../_django/start_django/image/1.startup/1704197812260.png)

After you enter createuser command,  Command line will ask you some questions as following:

![1704198150873](../../../_django/start_django/image/1.startup/1704198150873.png)
...
![1704198211393](../../../_django/start_django/image/1.startup/1704198211393.png)

You will see the following pages:

![1704198656872](../../../_django/start_django/image/1.startup/1704198656872.png)

If you add url /admin after the host,  an admin site entry page will be shown:

![1704198797173](../../../_django/start_django/image/1.startup/1704198797173.png)


Enter your admin & password( on last step you set),you will enter the site:

![1704198870426](../../../_django/start_django/image/1.startup/1704198870426.png)
